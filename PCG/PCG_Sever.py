...
def calculate_breath_rate(peaks, sample_rate):
    ...
    for i in range(1, len(peaks)):
        interval = (peaks[i] - peaks[i-1]) / sample_rate  # Tính khoảng cách thời gian giữa hai lần thở
...
while True:
        try:
            txt_filename = "D:/ESP/Espressif/frameworks/pillowControl/mqtt/uploads/dataINMP.txt"  # Đặt tên file .txt chứa dữ liệu tín hiệu
